...
print 'MOI:'
new_s = unicode("pourquoi cet été votre âtre côtier n'avait il pas accueilli l'évènement de François? Quelle naïveté!", 'utf-8')
res = latin1_to_ascii(new_s)
print res.replace(' ', '_').replace('?', '_').replace('!', '_').replace('__', '_').lower()
